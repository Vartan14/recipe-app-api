...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_update_user_returns_error(self):
        ...
        new_user = create_user(email='user2@example.com', password='test_pass123')
        recipe = create_recipe(user=self.user)
    ...
    def test_recipe_other_users_recipe_error(self):
        """Test trying to delete a recipe of other users returns an error."""
        other_user = create_user(email='user2@example', password='test_pass123')
    ...
    def test_update_recipe_with_assign_tags(self):
    ...
    def test_create_recipe_with_existing_ingredients(self):
        ...
        payload = {
            ...
            'time_minutes': 1,
            'price': '3.1',
            'ingredients': [{'name': 'Water'}, {'name': 'Lemon'}]
        }
        ...
        for ingredient in payload['ingredients']:
            exists = Ingredient.objects.filter(user=self.user, name=ingredient['name'])
            self.assertTrue(exists)
